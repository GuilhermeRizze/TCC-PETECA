...
<html>
	...
	<body>
		...
		<form action="adm/back_cad_provas.php" method="post">
			...
			<br><br>
			Titulo da Prova: <input type="text" name="titulo_provas" size="100"><br/><br/>
        	Digite o tempo da prova (HH:MM): <input type="time" name="time" value="00:40"required><br/><br>
            Insira a quantidade de questões: <input type="text" name="qtd" required></p>
				<center>
				<br>
