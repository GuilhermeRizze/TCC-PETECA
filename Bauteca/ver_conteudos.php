...
<html>
	...
	<td align="center" bgcolor="#FFFFFF"><a href="visualiza_conteudo.php?cod_bau=<?php echo $rows['cod_bau']; ?>"><?php echo $rows['professor']; ?></a><BR></td>
	<td align="center" bgcolor="#FFFFFF"><a href="visualiza_conteudo.php?cod_bau=<?php echo $rows['cod_bau']; ?>"><?php echo $rows['titulo']; ?></a><BR></td>
	...
	<tr>
	 ...
	 <center><a href="cadastra_conteudo.php?cod_materia=<?php echo $_REQUEST['cod_materia'] ?>">
	 <input type="button"value="Cadastrar novo conteúdo "size="20" style="background-color: #01DFD7 ; float: right;"></a></center> 
	</body>
</html>