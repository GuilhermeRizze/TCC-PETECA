...
<html>
	...
	<td bgcolor="#FFFFFF"><a href="roteiro_aluno.php?id=<?php echo $rows['id']; ?>"><?php echo $rows['professor']; ?></a><BR></td>
	<td align="center" bgcolor="#FFFFFF"><a href="roteiro_aluno.php?id=<?php echo $rows['id']; ?>"><?php echo $rows['titulo']; ?></a><BR></td>
	<td align="center" bgcolor="#FFFFFF"><a href="roteiro_aluno.php?id=<?php echo $rows['id'];?>"><?php echo $rows['created']; ?></a><BR></td>
	</tr>
	<?php
