...
<html lang="pt-br">
	...
	<body>
			 ...
			 <section id="banner" >
				<h2><strong>Vizualizar</strong> o Roteiro de Aprendizagem</h2>
	...
	<body>
		...
		<center><br><br> <a href="student/login_aluno.php"><input type="button"value="Voltar Para Pagina Inicial"size="20" style="background-color: #01DFD7"></a> </br></br></center>
		</form>
	</body>
</html>
